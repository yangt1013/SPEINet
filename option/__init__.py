...
parser.add_argument('--template', default='SPEINet',
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/yangt/ssd1/dataset/GOPRO_Large_all/newblur/train',
                    help='dataset directory')
parser.add_argument('--dir_data2', type=str, default='/home/yangt/ssd1/dataset/GOPRO_Large_all/newblur/train',
                    help='dataset directory')
parser.add_argument('--dir_data_test', type=str, default='/home/yangt/ssd1/STDAT/dataset/newblur/val',
                    help='dataset directory')
...
parser.add_argument('--pretrain_models_dir', type=str, default='../pretrain_models/',
                    help='file name to save')
parser.add_argument('--save', type=str, default='gpa',
                    help='file name to save')
