...
class Trainer_SPEINet(Trainer):
    def __init__(self, args, loader, my_model, my_loss, ckp):
        super(Trainer_SPEINet, self).__init__(args, loader, my_model, my_loss, ckp)
    ...
    def train(self):
        ...
        self.ckp.start_log()
        mid_loss_sum = 0.
        for batch, (input, gt, label, filename) in enumerate(self.loader_train):
